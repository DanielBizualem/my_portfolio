      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-16 relative z-10 grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5 space-y-8 text-center lg:text-left">
          ...
          <div className="space-y-3 max-w-md mx-auto lg:mx-0">
            {/* Email Node */}
            <div
              className="p-4 rounded-2xl border flex items-center justify-between gap-4 backdrop-blur-sm"
              style={{ backgroundColor: `${theme.panelBg}66`, borderColor: theme.panelBorder }}
            >
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl border" style={{ backgroundColor: theme.panelHeaderBg, borderColor: theme.panelBorder, color: theme.accent }}>
                  <Mail className="w-4 h-4" />
                </div>
                <div className="text-left">
                  <span className="text-[10px] uppercase font-mono tracking-wider block" style={{ color: theme.textMuted }}>Direct Mail channels</span>
                  <span className="text-xs font-bold tracking-tight" style={{ color: theme.text }}>danielbizualem4@gmail.com</span>
                </div>
              </div>
              ...
              <button
                ...
                style={{
                  backgroundColor: theme.panelHeaderBg,
                  borderColor: copied ? theme.accent : theme.panelBorder,
            ...
            >
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl border transition-colors duration-300" style={{ backgroundColor: theme.panelHeaderBg, borderColor: theme.panelBorder, color: theme.accent }}>
                ...
                <div className="text-left">
                  <span className="text-[10px] uppercase font-mono tracking-wider block" style={{ color: theme.textMuted }}>Voice / Telegram Connection</span>
                  <span className="text-xs font-bold tracking-tight" style={{ color: theme.text }}>+251 989 957 854</span>
                </div>
              </div>
              <div
                className="text-[10px] font-mono tracking-tight px-2 py-1 rounded border transition-colors duration-300"
                style={{ borderColor: theme.panelBorder, backgroundColor: theme.panelHeaderBg, color: theme.textMuted }}
              >
                CALL
              </div>
            </a>
          ...
          <div className="flex flex-wrap justify-center lg:justify-start items-center gap-3">
            <a
              ...
              style={{ backgroundColor: `${theme.panelBg}66`, borderColor: theme.panelBorder, color: theme.textMuted }}
            >
            ...
            <div
              className="text-[10px] font-mono tracking-tight px-3 py-1.5 rounded-lg border flex items-center gap-1.5"
              style={{ backgroundColor: theme.panelHeaderBg, borderColor: theme.panelBorder, color: theme.textMuted }}
            >
        ...
        <div className="lg:col-span-7">
          <div
            className={`p-6 md:p-8 rounded-2xl border transition-all duration-500 backdrop-blur-sm relative overflow-hidden ${
              isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
            style={{ backgroundColor: `${theme.panelBg}aa`, borderColor: theme.panelBorder, boxShadow: '0 20px 40px rgba(0,0,0,0.15)' }}
          >

            {formStatus === 'success' && (
              <div className="py-12 flex flex-col items-center justify-center text-center space-y-4 animate-fade-in">
                <div className="p-4 rounded-full border" style={{ backgroundColor: theme.panelHeaderBg, borderColor: theme.accent, color: theme.accent }}>
                  <CheckCircle className="w-8 h-8" />
                </div>
                <div className="space-y-1">
                  <h3 className="text-lg font-bold tracking-tight" style={{ color: theme.text }}>{successMessage}</h3>
            ...
            {formStatus === 'error' && (
              <div className="py-12 flex flex-col items-center justify-center text-center space-y-4 animate-fade-in">
                <div className="p-4 rounded-full border" style={{ backgroundColor: theme.panelHeaderBg, borderColor: theme.keyword, color: theme.keyword }}>
                  <Terminal className="w-8 h-8" />
                </div>
                <div className="space-y-1">
                  <h3 className="text-lg font-bold tracking-tight" style={{ color: theme.keyword }}>Pipeline Aborted</h3>
                  <p className="text-xs" style={{ color: theme.textMuted }}>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label htmlFor="name" className="text-[11px] font-mono font-bold uppercase tracking-wider" style={{ color: theme.textMuted }}>
                      Your Name
                    </label>
                    <input
                      type="text"
                      ...
                      style={{ backgroundColor: theme.panelHeaderBg, borderColor: theme.panelBorder, color: theme.text }}
                    />
                  </div>

                  <div className="space-y-1.5">
                    <label htmlFor="email" className="text-[11px] font-mono font-bold uppercase tracking-wider" style={{ color: theme.textMuted }}>
                      Your Email
                    </label>
                    <input
                      type="email"
                ...
                <div className="space-y-1.5">
                  <label htmlFor="message" className="text-[11px] font-mono font-bold uppercase tracking-wider" style={{ color: theme.textMuted }}>
                    Your Message
                  </label>
                  <textarea
                    id="message"
                ...
                <button
                  type="submit"
                  disabled={formStatus === 'submitting'}
                  className="w-full py-3.5 px-4 rounded-xl font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all duration-300 group disabled:opacity-50"
            ...
            <div className="mt-5 pt-4 border-t flex items-center gap-1.5 font-mono text-[9px] uppercase tracking-normal" style={{ borderColor: theme.panelBorder, color: theme.textMuted }}>
            </div>
